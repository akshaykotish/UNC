...
class UNCIcons{
    static Map<String, String> images = <String, String>{
      "seedfundclose": "./assets/uncicons/seedfundclose.png",
      ...
      "seed": "./assets/uncicons/seeds.png",
      "token": "./assets/uncicons/token.png",
      "usdt": "./assets/uncicons/usdt.png",
      "unc": "./assets/uncicons/prestageopen.png",
      "prestageopen": "./assets/uncicons/prestageopen.png",
    };
}